...
import { memo, use, spread, insert, createComponent, mergeProps, template } from 'solid-js/web';
import { createSignal, createEffect, splitProps, onMount, onCleanup } from 'solid-js';
...
function useInternalValues(value, defaultValue, valueIsNumericString, format, removeFormatting) {
  ...
  var _createSignal = createSignal(initialValues),
...
var _tmpl$ = /*#__PURE__*/template("<span>"),
  _tmpl$2 = /*#__PURE__*/template("<input>");
...
function NumberFormatBase(props) {
  ...
  var _splitProps = splitProps(props, ['type', 'displayType', 'customInput', 'renderText', 'getInputRef', 'format', 'removeFormatting', 'defaultValue', 'valueIsNumericString', 'onValueChange', 'isAllowed', 'onChange', 'onKeyDown', 'onMouseUp', 'onFocus', 'onBlur', 'value', 'getCaretBoundary', 'isValidInputCharacter', 'isCharacterSame']),
  ...
  if (displayType === 'text') {
    return local.renderText ? memo(function () {
      return local.renderText(formattedValue(), otherProps) || null;
    }) : function () {
      var _el$ = _tmpl$();
      var _ref$ = local.getInputRef;
      typeof _ref$ === "function" ? use(_ref$, _el$) : local.getInputRef = _el$;
      spread(_el$, otherProps, false, true);
      insert(_el$, formattedValue);
      return _el$;
    }();
  } else if (local.customInput) {
    var CustomInput = local.customInput;
    /* @ts-ignore */
    return createComponent(CustomInput, mergeProps(inputProps, {
      ref: function ref(r$) {
  ...
  return function () {
    ...
    typeof _ref$3 === "function" ? use(_ref$3, _el$2) : local.getInputRef = _el$2;
...
function format(numStr, props) {
  var _a, _b, _c;
  var _splitProps = splitProps(props, ['decimalScale', 'fixedDecimalScale', 'prefix', 'suffix', 'allowNegative', 'thousandsGroupStyle']),
    _splitProps2 = _slicedToArray(_splitProps, 2),
    local = _splitProps2[0],
    _ = _splitProps2[1];
...
function getSeparators(props) {
  var _a;
  var _splitProps3 = splitProps(props, ['decimalSeparator', 'thousandSeparator', 'allowedDecimalSeparators']),
...
function removeFormatting(value) {
  ...
  var _a, _b;
  var _splitProps5 = splitProps(props, ['allowNegative', 'prefix', 'suffix', 'decimalScale']),
...
function _getCaretBoundary(formattedValue, props) {
  var _a, _b;
  var _splitProps7 = splitProps(props, ['prefix', 'suffix']),
...
function validateAndUpdateProps(props) {
  ...
  var _splitProps9 = splitProps(props, ['prefix', 'allowNegative']),
...
function useNumericFormat(props) {
  ...
  var _splitProps1 = splitProps(props, ['decimalSeparator', 'allowedDecimalSeparators', 'thousandsGroupStyle', 'suffix', 'allowNegative', 'allowLeadingZeros', 'onKeyDown', 'onBlur', 'thousandSeparator', 'decimalScale', 'fixedDecimalScale', 'prefix', 'defaultValue', 'value', 'valueIsNumericString', 'onValueChange']),
...
function NumericFormat(props) {
  ...
  return createComponent(NumberFormatBase, numericFormatProps);
}
...
function usePatternFormat(props) {
  var _a, _b, _c, _d;
  var _splitProps = splitProps(props, ['mask', 'allowEmptyFormatting', 'format', 'inputMode', 'onKeyDown', 'patternChar', 'value', 'defaultValue', 'valueIsNumericString']),
    _splitProps2 = _slicedToArray(_splitProps, 2),
    local = _splitProps2[0],
...
function PatternFormat(props) {
  ...
  return createComponent(NumberFormatBase, patternFormatProps);
}

export { NumberFormatBase, NumericFormat, PatternFormat, _getCaretBoundary as getNumericCaretBoundary, getCaretBoundary as getPatternCaretBoundary, format as numericFormatter, _format as patternFormatter, removeFormatting as removeNumericFormat, _removeFormatting as removePatternFormat, useNumericFormat, usePatternFormat };
